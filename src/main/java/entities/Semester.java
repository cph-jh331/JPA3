...
public class Semester implements Serializable {
    ...
    public boolean addStudentToSem(Student student)
    {
    ...
    {
        return "Semester{" + "id=" + id + ", description=" + description + ", name=" + name + ", teacherCollection=" + teacherCollection + ", studentCollection=" + studentCollection + '}';
    }
